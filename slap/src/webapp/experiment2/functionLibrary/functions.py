...
import json
with open('slap/src/webapp/experiment2/webpages/default.html', 'r') as read:
    html_default = read.read()
with open('slap/src/webapp/experiment2/webpages/getTime.html', 'r') as read:
    html_getTime = read.read()
with open('slap/src/webapp/html/changeAngle.html', 'r') as read:
