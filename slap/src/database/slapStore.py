...
class Boat():
    ...
    def __init__(self, name: str, id: int , model: str, proportional: int, integral: int, differential: int):
        self.name = name
        self.boatId = id
        self.model = model
...
class SlapStore():
    ...
    def addBoat(self, boat: Boat):  
        self.cursor.execute(f"INSERT INTO BOATS (boatId, boatName, boatModel, proportional, intergral, differential) VALUES ('{boat.boatId}','{boat.name}','{boat.model}','{boat.proportional}','{boat.integral}','{boat.differential}')")
